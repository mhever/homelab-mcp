...
### 🛠️ Execution Rule
1. **Command:** You MUST use the local shim: `deepseek "deepseek/deepseek-chat" "Task: [INSTRUCTION] Context: $(cat target_file)"`
2. **Model:** Always use `deepseek/deepseek-chat`. Do not use reasoning models for boilerplate or standard implementation to save costs.
